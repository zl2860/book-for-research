...
食管鳞状细胞癌（ESCC）真正棘手的时刻，往往不是病理已经确认肿瘤，而是患者初诊时转移已经发生。论文引用的临床背景显示，超过一半患者初诊时已有转移，5 年总生存率约为 20%；只盯着肿瘤细胞本身，很难解释为什么有些原发灶更早形成转移能力。（来源：`P001.S0002–P001.S0006`、`P001.S0018–P001.S0019`）

研究者可以把肿瘤拆成十万级单细胞，却也可能在解离组织时丢掉一个关键问题：哪些细胞正贴近侵袭前沿，并向肿瘤细胞发送信号。周细胞位于血管基底膜，数量少，过去常被当作一个整体；既往研究甚至同时把它描述为促肿瘤参与者和抗肿瘤“守门人”。（来源：`P001.S0020–P001.S0022`、`P003.S0009–P003.S0011`）

因此，这项研究问的不是“ESCC 里有哪些细胞”，而是：转移与非转移原发灶之间，哪一种微环境细胞的数量、位置和通信变化最突出；这种变化究竟只是伴随转移，还是能够推动转移并削弱免疫反应。

作者给出的答案是一类 **GPR116+ 周细胞**。人体样本先提供转移关联和空间线索，体外实验与小鼠模型再支持其功能；机制上，PRRX1 塑造这一周细胞状态，周细胞分泌的 EGFL6 与肿瘤细胞 integrin β1–NF-κB/EMT 信号相连，并伴随 Treg 增加、CD8+ T 细胞效应下降和肿瘤 PD-L1 上调。血清 EGFL6 与 integrin β1 阻断由此成为两个转化出口，但前者仍是候选标志物，后者仍是临床前治疗证据。（来源：`P006.S0017–P006.S0064`、`P009.S0028–P011.S0047`、`P011.S0048–P011.S0064`）

## 01｜在转移相关微环境里，最先值得追的是哪类细胞？

作者先比较 12 位 ESCC 患者的原发灶：非转移组 6 位、转移组 6 位，另有 4 份来自转移患者的配对癌旁组织。scRNA-seq 质控后保留 117,169 个细胞，分成 14 类主要细胞；这一步的目的不是立即找一个“转移基因”，而是先判断哪类微环境细胞在两组之间变化最突出。（来源：`P003.S0017–P003.S0033`、`P016.S0010–P016.S0013`、`P016.S0031`）

细胞通信推断把周细胞列为转移组中外向信号增幅最大的细胞，与上皮细胞的互动增幅也最大。随后，作者在 5 位患者的 Stereo-seq 数据中比较非转移 2 位与转移 3 位患者；结果显示，转移组的周细胞更靠近肿瘤细胞。这里的“通信”和“靠近”都只是候选筛选：前者来自表达模型，后者来自空间共定位，均不能单独证明因果。（来源：`P003.S0034–P003.S0047`）
...
- **人体发现层：**12 位患者、16 份组织；scRNA-seq 为 117,169 个细胞，配对多组学的 snATAC-seq 质控后为 109,183 个细胞。（来源：`P016.S0010–P016.S0013`、`P016.S0031`、`P016.S0055`）
- **空间层：**5 位患者、195,366 个 bin50 pseudo-spots/cells；bin50 直径约 25 μm，并不等同于严格单细胞。（来源：`P003.S0039`、`P016.S0041–P016.S0042`）
- **跨数据集与组织验证层：**整合队列比较转移患者 29 位与非转移患者 25 位；组织微阵列比较癌旁正常 164 份、非转移肿瘤 96 份和转移肿瘤 104 份。生存与 Cox 分析报告 n=200；因补充表缺失，无法核实这 200 位患者与上述组织微阵列样本的重叠关系。（来源：`P003.S0009`、`P003.S0024–P003.S0026`、`P005.S0074–P006.S0015`）
- **血清与模型层：**ESCC 血清队列为患者 135 位、健康对照 60 位；体外实验多数每组 3–5 个重复，小鼠治疗实验每组 4–7 只。（来源：`P016.S0021–P016.S0023`、`P006.S0036–P006.S0038`、`P009.S0036–P009.S0039`、`P011.S0045–P011.S0064`）
...
周细胞重聚类后分成 STEAP4+、SORBS2+ 和 GPR116+ 三个亚群。SORBS2+ 亚群偏向正常组织，STEAP4+ 分布较均匀，GPR116+ 亚群则在转移病例中富集；这一方向在作者数据与 4 个公开 ESCC scRNA-seq 数据集整合后仍然存在，比较对象是转移患者 29 位与非转移患者 25 位。（来源：`P003.S0048–P005.S0078`）
...
组织层验证比较了癌旁正常 164 份、非转移肿瘤 96 份和转移肿瘤 104 份，转移组的 GPR116+ 周细胞更多。在报告 n = 200 的多变量 Cox 模型中，GPR116+ 周细胞比例高组相对低组的 HR = 1.4（95% CI 1.0–2.0，P = 0.038）；这说明它在模型调整后仍与风险相关，但不能证明它导致患者死亡，也不等于已经形成可用的临床分层阈值。（来源：`P002.S0060–P002.S0062`、`P003.S0025–P003.S0026`、`P006.S0009–P006.S0016`）

GPR116 在这里首先是一个细胞状态标签。研究真正要验证的，是整类 GPR116+ 周细胞的功能，而不是预先假定 GPR116 这个表面分子本身就是促转移效应分子。

## 04｜它真的推动转移，还是只与转移同时出现？

人体数据先回答“同时出现”：GPR116+ 周细胞在转移原发灶中更多，也更靠近高 EMT 潜能肿瘤细胞。这里的 EMT 是基于上皮与间质基因特征计算的状态分数，空间细胞身份又依赖参考映射；所以这部分证据支持邻近和关联，还不能确定作用方向。（来源：`P007.S0004–P009.S0009`、`P016.S0044–P016.S0049`、`P017.S0008–P017.S0010`）

要判断是否存在功能作用，作者随后比较 GPR116− 与 GPR116+ 周细胞。体外 2D/3D 模型中，GPR116+ 周细胞更强地促进 ESCC 细胞侵袭和 EMT；在足垫模型中，GPR116− 周细胞组有 3/6 只小鼠发生腘窝淋巴结转移，GPR116+ 周细胞组则为 6/6。（来源：`P009.S0010–P009.S0021`）
...
反向证据来自周细胞特异性 Prrx1 条件敲除。对照组 5/5 出现淋巴结转移，敲除组为 1/5；原文用了“消除”转移的措辞，但 1/5 并不是零，因此更准确的理解是转移率在这一小样本模型中明显下降。（来源：`P009.S0022–P009.S0027`）

这组结果把证据从人体关联推进到了模型内因果，但仍不能排除 Prrx1 敲除改变其他周细胞状态，也不能把足垫或尾静脉模型直接外推成人类自然转移过程。

## 05｜PRRX1–EGFL6–integrin β1–NF-κB 这条证据链怎样建立？

作者先找 GPR116+ 周细胞的上游。三个筛选条件分别得到 33 个在该亚群中活化的调控因子、282 个相对 GPR116− 周细胞高表达的基因，以及 66 个在转移患者周细胞中上调的基因；交集只剩 PRRX1、SOX4 和 HIF1A，PRRX1 与 GPR116+ 亚群标志的相关最强。（来源：`P006.S0017–P006.S0024`）

相关性之后还有多层验证：PRRX1 过表达使 GPR116+ 周细胞比例升高；snATAC-seq 显示 GPR116、EGFL6 等位点在该亚群中更开放；ChIP 与报告基因实验支持 PRRX1 对 GPR116、EGFL6 启动子的调控；Prrx1 条件敲除小鼠的肿瘤中则未见可检测的 GPR116+ 周细胞。需要保留的边界是，ChIP 使用 HEK293T 细胞背景，“未见”也受检测限和模型范围约束。（来源：`P006.S0040–P006.S0064`）

下游链条从 EGFL6 开始。它是 GPR116+ 相对 GPR116− 周细胞中上调最强的基因，重组 EGFL6 能以剂量依赖方式增强 ESCC 细胞侵袭和 EMT；配体–受体分析随后提出 integrin β1，免疫共沉淀支持二者处于同一物理复合物，p-p65 上升以及 ATN-161、BAY 11-7082 的药理拯救把信号接到 NF-κB 与 EMT。（来源：`P009.S0028–P009.S0047`、`P009.S0066–P011.S0020`）
...
简明图注：图 5 由通信推断提出 EGFL6–integrin β1，继而以免疫共沉淀、NF-κB/EMT readout、两类抑制剂拯救及 volociximab 小鼠实验补强；IP 不能单独证明直接结合界面，药理实验也不能完全排除靶外效应。

这条链之所以有解释力，是因为它同时连接了周细胞状态的形成和肿瘤细胞端的可干预输出。但论文没有完成 EGFL6 特异性 loss-of-function，也没有用 ITGB1 遗传扰动排除药理非特异性，因此“唯一且必需的通路”仍未被证明。

## 06｜为什么同一亚群还会压低抗肿瘤免疫？

在 15 份 ESCC 组织的多重免疫荧光中，GPR116+ 周细胞附近富集 PD-1+CD8+ T 细胞和 FOXP3+CD4+ Treg，转移病例中的富集更高。这个结果说明三类细胞在组织中相关并邻近，但不能单凭空间图像判断是谁诱导了谁。（来源：`P011.S0030–P011.S0035`）

共培养把证据向功能推进了一步。与 GPR116− 周细胞相比，GPR116+ 周细胞使 PD-1+CD8+ T 细胞和 FOXP3+CD4+ Treg 比例上升（每组 n=4）；其条件培养基降低 PBMC 杀伤，并降低 CD8+ T 细胞的 CD107a、GZMB 和 perforin（每组 n=3）。这些变化可以来自状态转变、增殖或选择性存活，实验并未做完整谱系追踪。（来源：`P011.S0036–P011.S0040`）

同一周细胞亚群还使 ESCC 细胞 PD-L1 上调，而 integrin β1 抑制剂可削弱该效应（每组 n=3）。这为后续联合 αPD-1 提供了机制理由：阻断 integrin β1 可能同时压低侵袭信号和一部分免疫抑制输出。但“机制理由”不等于患者中的免疫治疗增敏已经得到证实。（来源：`P011.S0041–P011.S0047`）

## 07｜血清 EGFL6 现在能回答什么问题？

第一个出口是血清 EGFL6。作者合并两个中心的 135 位 ESCC 患者，并以 60 位健康者作对照；研究内 ROC 中，EGFL6 区分 ESCC 与健康者的 AUC 为 0.983，区分转移与非转移 ESCC 的 AUC 为 0.912。肺癌转移队列的 AUC 为 0.902，胃癌转移队列为 0.808；这些数字比较的是各研究队列内的分类表现，不是与现行筛查或影像流程的头对头临床比较。（来源：`P009.S0055–P009.S0064`）
...
第二个出口是 integrin β1 阻断。足垫模型中，对照组近端腘窝和髂淋巴结转移均为 6/6，远端肾门淋巴结为 4/6；volociximab 组近端只报告 1/6 的少量浸润，远端为 0/6。随后，ATN-161 与 αPD-1 在 AKR 皮下模型（每组 n=7）和 4NQO 自发 ESCC 模型（每组 n=4）中均表现为联合组优于任一单药。（来源：`P011.S0021–P011.S0029`、`P011.S0052–P011.S0064`）

这里可以说“联合显示临床前增益”，不能直接说“协同”或“改善临床结局”：论文没有报告正式交互作用检验，也没有患者接受这一联合方案。体重、血液学和器官组织学未见明显异常，只能说明这些小样本、有限观察期的小鼠实验没有发现相应安全信号。

## 09｜这些结果仍需要冷静看待：哪些结论还不能下？

第一，患者层发现样本只有 12 位，空间队列只有 5 位，而且比较的是已经有或没有转移的原发灶。117,169 个细胞和 195,366 个空间 pseudo-spots 提高的是细胞或空间单位层面的观测密度，不能替代患者层重复，也不能确定 GPR116+ 周细胞是在转移前出现还是转移后的反应。

第二，空间结论依赖约 25 μm 的 bin50、外部 GSE160269 参考去卷积和 SpaCET 恶性判别；CellChat 又由作者人工加入 21 个 EGFL6 受体候选。空间邻近和通信概率适合筛选机制，不等同于直接测量细胞接触、蛋白分泌或信号因果。（来源：`P016.S0041–P017.S0007`）

第三，作者没有用统计方法预先确定样本量，多处动物实验每组仅 4–7 只。尾静脉模型绕过原发灶侵袭和入血，足垫模型还把“淋巴结转移”和“局部肿瘤侵袭”放在同一操作性定义中；这些模型支持所用条件下的功能，却不能完整重现人类 ESCC 自然转移。（来源：`P017.S0028–P017.S0035`、`P018.S0045`）

第四，临床转化仍缺独立验证。血清 EGFL6 的高 AUC 来自研究内队列，没有预设临床阈值与前瞻性验证；integrin β1 阻断和 αPD-1 联合只有小鼠证据，尚无人类疗效数据。

第五，原文和随文材料存在必须保留的冲突：Fig. 4 图注与队列构成把 ESCC 血清转移/非转移人数写反；主文与 Reporting Summary 对 CD146 门控、随机化和动物伦理机构的表述不一致；Supplementary Note、Tables 1–7、Supplementary Figs. 1–2 和独立 Source Data 文件又不在本地 PDF 中。完整冲突、低置信解析和缺失材料清单均保留在技术附录，不能用一种表述静默覆盖另一种。

## 10｜对新的空间肿瘤研究，哪些设计可以直接迁移？

最值得迁移的不是某一个 marker，而是一条候选收敛路径：先在患者层比较中寻找通信变化突出的稀有细胞，再做亚群拆分；随后用空间侵袭前沿过滤候选，以组织成像确认位置，最后才进入体外扰动、遗传模型和药理验证。空间信息在这里是功能实验前的优先级过滤器，不是因果结论本身。

复用这一路线时，患者应始终作为生物学重复单位，并预先定义主要终点、样本量、多重检验、随机化和盲法。若目标是预测转移或免疫治疗反应，还需要转移前纵向样本、治疗前后配对组织和独立验证队列，而不只是横断面比较。

联合治疗也应携带机制 readout。本文先观察 integrin β1 抑制可削弱 PD-L1 上调，再进入与 αPD-1 的两种小鼠模型；迁移到其他研究时，同样需要预先说明“为什么联合”、测量哪一个药效标志，以及什么结果会否定机制。

对胃癌等其他癌种，只能迁移设计，不能直接搬运机制。本文胃癌血清队列中 EGFL6 区分转移的 AUC 为 0.808，但没有证明其来源仍是 GPR116+ 周细胞，也没有复现 PRRX1–EGFL6–integrin β1 轴；新的癌种必须重新确认细胞来源、空间位置和通路依赖。（来源：`P009.S0062–P009.S0065`）

---

## 技术附录

以下内容从原笔记的“基本信息”开始完整保留，用于核查论文事实、主图与 Extended Data、PDF 解析质量、来源句子 ID、Results/Methods 覆盖、完整方法参数、原文内部冲突、低置信抽取和缺失材料。上方读者正文只重组叙事，不替代下方任何证据记录。
