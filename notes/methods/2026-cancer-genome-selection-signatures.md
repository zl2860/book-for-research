...
|---|---|---|---|
| `P015.S0001–P016.S0008` | 175 个高置信候选、69 个既往未列驱动、非编码独有数量冲突、OncoKB 21/80，以及另有 328 个单癌种/单队列候选。 | [06](#06｜哪些非编码候选最值得关注)、[09](#09｜这项工作真正改变了什么)、[11](#11｜这些结果仍需要冷静看待) | 328 个候选不满足 175 个候选的跨癌种/跨队列门槛；可行动基因重叠不等于具体变异可用药。 |
| `P016.S0009–P017.S0016` | `ω` 的相对约束含义、负选择四项可能机制、TERT 的作者解释，以及 PARP2、PARP12、PARP16、TIPARP 的合成致死候选出口。 | [07](#07｜负选择如何改写我们对-tert-的理解)、[08](#08｜为什么会看到全基因组负选择信号)、[09](#09｜这项工作真正改变了什么)、[11](#11｜这些结果仍需要冷静看待) | 四项机制来自作者结合文献的解释；本文未直接检验 TERT 调控机制、合成致死或药物反应。 |
| `P017.S0017–P018.S0008` | 分数二分、单样本不可用、癌种样本不均衡与欧洲祖源等限制。 | [11](#11｜这些结果仍需要冷静看待) | 这些是作者 Discussion 的适用边界，不是新的独立验证。 |
