...
16 个基因呈现“全基因负选择、非编码元件正选择”的双向模式。TERT 最典型：启动子在 15 个癌种受正选择，编码区在 5 个癌种受负选择；C228T 与 C250T 热点涉及 1,041 名患者。作者据此提出，区域相反的选择方向或可解释为什么 TERT 驱动改变主要集中在启动子；但本文没有直接测量 TERT 表达、端粒酶活性或编码变异的细胞适应度，不能把“提高调控活性、保留蛋白功能”写成已验证机制。
